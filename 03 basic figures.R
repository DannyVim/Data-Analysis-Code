...
boxplot(var,horizontal = , axes=TRUE, ylim=c(0,100))
## 分组
...
lines(data$var2[Ord],M.Loess$fitted[Ord],lwd=1,lty=1,col=2)
## 高密度散点图
...
## 气泡图
symbols(var1,var2,circles=var3,inches=0.1, fg='white',bg='lightblue')
## 矩阵散点图
pairs(formula)
...
### 使用corrgram包
library(corrgram)
corrgram(矩阵,lower.panel = panel.pts,upper.panel = panel.ellipse,diag.panel = panel.minmax)
## 分组散点图
